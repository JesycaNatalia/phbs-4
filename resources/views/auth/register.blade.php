		...
		<div class="login-content">
			...
			<form action="{{ route('register') }}" method="POST" class="margin-bottom-0">
				...
				<div class="form-group m-b-15">
					<input id="email" type="text" class="form-control form-control-lg" name="username" value="{{ old('username') }}" required autocomplete="username" placeholder="Username" autofocus />
				</div>
				<div class="form-group m-b-15">
